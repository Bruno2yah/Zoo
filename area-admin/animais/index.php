...
<body style="justify-content: center; align-items: center; height: 100vh ">
   <?php 
      require_once(__DIR__ . '../../../componentes/header-adm.php');

  ?> 
  <div class="container-fluid" style="height: 90vh">
    <div class="row h-100">
      <?php 
      require_once(__DIR__ . '../../../componentes/menu-adm.php');
              ...
              <tr>
                ...
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$animal[0]?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$animal[0]?>,'idDeletar')">
  ...
  <?php
     require_once(__DIR__ . '../../../componentes/modal.php');
  ?>
